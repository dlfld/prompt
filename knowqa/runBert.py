...
parser.add_argument("--bert_model",type=str,default='/home/dlf/prompt/knowqa/models/bert')

parser.add_argument("--config_file",type=str,help="The path to save log.",default='/home/dlf/prompt/knowqa/conf.json')
parser.add_argument("--dataset_script_dir",type=str,help="The path to save log.",default='/home/dlf/prompt/knowqa/data_scripts')
