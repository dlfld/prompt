...
def generate_prompt(sentence: str, word: str, pre_part_of_speech: str, pre_word: str, part_of_speech: str,
    ...
    template4 = "在句子“{sentence}”中，词语“{word}”的前文如果是由“{pre_part_of_speech}”词性的词语“{pre_word}”来修饰，那么词语“{word}”的词性是“[MASK]”？，请从以下标签中挑选出最终结果：[{labels}]，→ {part_of_speech}"
    ...
    template_pt = "[T][T]{sentence}[T][T]{word}[T][T]{pre_part_of_speech}[T][T]{pre_word}[T][T]{word}[T][T][MASK]→ {part_of_speech}"
