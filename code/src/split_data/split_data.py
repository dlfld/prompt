...
def split_data_train(data_num, sampling_nums, save_path):
    ...
    """
    test_data = joblib.load("/home/dlf/p-tuning/code/data/split_data/pos_seg_train.data")
    total_data = []
...
def split_dataset_3_7():
    ...
    for index, item in enumerate(data_list):
        split_data_train(5, item, f"/home/dlf/p-tuning/code/data/split_data/{item}/{item}.data")
...
def split_dataset_1_9():
    """
     一九分数据集
    """
    save_path = "/home/dlf/p-tuning/code/data/split_data/1_9_split"
    standard_data = load_data("/home/dlf/p-tuning/code/data/jw/after_pos_seg.txt")
...
def split_ctb_dataset_1_9():
    """
     一九分数据集
    """
    save_path = "/home/dlf/p-tuning/code/data/ctb/split_data/1_9_split"
...
def split_ud():
    ...
    # joblib.dump(datas,"/Users/dailinfeng/Desktop/p-tuning/code/data/ud/ud_en/train.data")
...
if __name__ == '__main__':
    # =================================================将数据三七分==========================================
    # datas = load_data("/home/dlf/p-tuning/code/data/jw/after_pos_seg.txt")
    ...
    # datas = joblib.load("/home/dlf/p-tuning/code/data/split_data/pos_seg_train.data")
    # split_data_few_shot("/home/dlf/p-tuning/code/data/ctb/split_data/few_shot/fold/", datas,
    #                     [5, 10, 15, 20, 25, 50, 75, 100, 200, 500, 1000], 5)
    # =================================================在三分的数据中划分数据==================================
    # =================================================在七分的数据中抽取出指定条数的数据==========================
    # test_datas = joblib.load("/home/dlf/p-tuning/code/data/ctb/split_data/few_shot/ctb_test.data")
    ...
    # joblib.dump(one_tentn_test_datas, "/home/dlf/p-tuning/code/data/ctb/split_data/few_shot/test_1500.data")
    # ids_index = [str(item) + "\n" for item in ids]
    # save("/home/dlf/p-tuning/code/data/ctb/split_data/few_shot/test_1500.txt", ids_index)
